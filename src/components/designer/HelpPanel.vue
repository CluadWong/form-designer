      ...
      <div class="v2-help__body">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <th>网格</th>
              <td>按行列划分的布局区，把票分成若干区块。</td>
            </tr>
            <tr>
              <th>表格</th>
              <td>多行多列的表。用于设备清单、措施列表等。</td>
            </tr>
          </tbody>
        </table>
        <p>
          <b>右侧属性面板</b
          >（选中后显示）：页面＝纸张/边距/页眉页脚/分页；网格＝列数/边框/间距/行数；格子＝撑满/内边距/对齐；文本＝文字/字号/加粗/对齐；输入框＝字段名/输入方式/宽度/默认值/内边框；图片＝地址/填充方式/尺寸；表格＝行列数/边框。顶部会显示当前选中（如「格子
          1-2」）。
        </p>
